...
const TABLE_SPECS: Record<SyncTable, Record<string, FieldSpec>> = {
  ...
  tour_stops: {
    ...
    object_id: { t: "text", max: 64 },
    is_unknown: { t: "bool" },
    unknown_target_id: { t: "text", max: 100 },
    unknown_name: { t: "text", max: 200 },
    unknown_address: { t: "text", max: 300 },
    unknown_latitude: { t: "number", min: -90, max: 90 },
    unknown_longitude: { t: "number", min: -180, max: 180 },
    stop_order: { t: "number", min: 0, max: 100000, int: true },
    arrival_time: { t: "hhmm" },
    is_delivered: { t: "bool" },
    is_undeliverable: { t: "bool" },
    undeliverable_reason: { t: "text", max: 500 },
    key_number: { t: "number", min: 1, max: 100000, int: true },
